<%@ Page Title="" Language="C#" MasterPageFile="~/FinalUser.Master" AutoEventWireup="true" CodeBehind="vendorDisplayC.aspx.cs" Inherits="ASE_Project.vendorDisplayC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:Panel id="pan2" runat="server" ScrollBars="Auto" Height="489px" > 
           <asp:Label ID="c1" runat="server" Text="Label" Visible="False"></asp:Label>
           <br />
    
           <h2 class="style">Catering Vendors</h2>
    
           <asp:Repeater ID="vencat" runat="server">
    		...
    		<div style="float:left;width:300px;">
    			<h5 class="cufon" ><a href="vendor_single.aspx?vendor_name=<%#DataBinder.Eval(Container.DataItem, "vendor_name")%>"><%#  DataBinder.Eval(Container.DataItem, "vendor_name")%></a></h5>
